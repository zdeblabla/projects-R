...
-   The whole source code and underlying data files for this presentation are available at the [Github repository of the same name](https://github.com/zdeblabla/projects-R)
